...
- Primary: visitor understands the agent-compiler feedback loop within 10 seconds of scrolling to the section
- Leading: the terminal demo is visually compelling enough to pause scrolling
- Guardrail: section does not break the concise editorial feel established in the redesign
...
- The section should feel different from the Pitch terminal - more dramatic, showing a conversation not a command
- Consider a two-column layout: brief prose left, terminal right (mirrors Pitch but inverted emphasis)
